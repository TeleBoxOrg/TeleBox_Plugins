...
function drawGradientRoundRect (colorOne, colorTwo, w, h, r, tailSize = 0) {
  ...
  // QuotLy-style bubble: visible dark-purple gradient from upper-left to lower-right.
  // Keep the first color as the darker/base side and the second as the lifted purple side.
  const gradient = ctx.createLinearGradient(0, 0, w, h)
  gradient.addColorStop(0, colorTwo)
